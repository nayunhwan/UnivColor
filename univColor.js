...
function getColorByUnivName(univ) {
  ...
  if (univ == "UT" || univ.includes("UT Austin") || univ.includes("University of Texas at Austin")) return "#BF5700";
  ...
  if (univ == "CWRU" || univ.toLowerCase().replace(/\s+/g, '').includes("casewestern") || univ.toLowerCase().replace(/\s+/g, '').includes("케이스")) return "#0A304E";
  ...
  if (univ == "CU"  || univ.includes("조선대")) return "#0054a7";
  if (univ == "CST" || univ.includes("조선이공대")) return "#018C85";
  ...
  if (univ == "HNU" || univ.includes("한남대")) return "#c74a55";
  ...
  if (univ =="HSUV" || univ.includes("한신대")) return "#38217C";
  return "#000000";
}
